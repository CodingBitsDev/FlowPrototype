...
(function(){
    _initState();
    window.flowAPI.setState = setState;
    window.flowAPI.addStateListener = addStateListener;
    window.flowAPI.removeListener = removeListener;
    window.flowAPI.getState = getState;
})()